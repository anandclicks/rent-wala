...
const rawProperties = [
  {
    ...
    description:
      "Spacious 3 BHK apartment in prime Sector 62, Noida. Features modular kitchen, wide balcony, park-facing views, 24x7 security, and dedicated covered parking.",
    category: "APARTMENT",
    listingType: "RENT",
    city: "Noida",
    locality: "Sector 62",
  ...
  },
  {
    ...
    title: "Zolo Nord PG",
    description:
      "Premium co-living PG for working professionals and students. All meals included, high-speed Wi-Fi, daily housekeeping, gym, and 24x7 CCTV security.",
    category: "PG",
    listingType: "RENT",
    city: "Noida",
    locality: "Sector 43",
    ...
    amenities: ["Wi-Fi", "Meals", "Housekeeping", "Gym", "24x7 Security", "Power Backup", "Laundry", "RO Water", "TV", "Indoor Games"],
    featureTags: ["All Meals Included", "High-Speed Wi-Fi", "Fully Furnished", "24x7 Security"],
    highlights: ["Close to Metro Station", "Flexible rental plans", "Managed co-living space", "No hidden charges"],
    nearbyLocations: [
    ...
    roomOptions: [
      { name: "Private Room", price: 12899, image: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?auto=format&fit=crop&w=400&q=80", furniture: ["Single bed", "Study table", "Wardrobe", "Chair"] },
      { name: "Two Sharing", price: 8999, image: "https://images.unsplash.com/photo-1560185127-6ed189bf02f4?auto=format&fit=crop&w=400&q=80", furniture: ["Single bed", "Wardrobe", "Study table"] },
      { name: "Three Sharing", price: 6999, image: "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&w=400&q=80", furniture: ["Single bed", "Wardrobe"] },
    ],
    images: [
  ...
  },
  {
    ...
    description: "Independent 4 BHK villa in DLF Phase 3 with private garden, servant room, modular kitchen, and triple car parking.",
    category: "VILLA",
    listingType: "SELL",
    city: "Gurugram",
  ...
  },
  {
    ...
    description: "Well-ventilated 2 BHK close to Dwarka metro with park-facing balcony and reserved parking.",
    category: "APARTMENT",
    listingType: "RENT",
    city: "Delhi",
    locality: "Dwarka",
  ...
  },
  {
    ...
    description: "Modern 2 BHK near tech parks. Fully furnished with AC, modular kitchen, and high-speed internet.",
    category: "APARTMENT",
    listingType: "RENT",
    city: "Bangalore",
  ...
  },
  {
    ...
    description: "Spacious independent house with terrace, front lawn, and separate servant quarter.",
  ...
  },
  {
    ...
    description: "Premium builder floor with independent entry, marble flooring, and rooftop access.",
  ...
  },
  {
    ...
    description: "Ready-to-move furnished office with reception, cabins, workstations, and conference room.",
    category: "COMMERCIAL",
    listingType: "RENT",
    city: "Noida",
    locality: "Sector 135",
  ...
  },
  {
    ...
    description: "Compact studio with AC, wardrobe, kitchenette. Walking distance from Gomti Nagar metro.",
    category: "STUDIO",
    listingType: "RENT",
    city: "Lucknow",
  ...
  },
  {
    ...
    description: "Ultra-luxury penthouse with private terrace, jacuzzi, smart home automation, and panoramic views.",
    category: "PENTHOUSE",
    listingType: "SELL",
    city: "Delhi",
    ...
    amenities: ["Lift", "Parking", "Power Backup", "Security", "Gym", "Swimming Pool", "Club House", "Terrace", "Smart Home"],
    images: [
...
function mergeProperty(raw) {
  const extra = enrichments[raw.slug] || {};
  return {
    id: raw.slug,
    ...raw,
    availability: raw.availability || extra.availability || "Ready to Move",
    featureTags: raw.featureTags || extra.featureTags || [],
    highlights: raw.highlights || extra.highlights || [],
    nearbyLocations: raw.nearbyLocations || extra.nearbyLocations || [],
    badges: raw.badges || [],
...
const PROPERTIES = rawProperties.map(mergeProperty);
